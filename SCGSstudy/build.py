...
<style>
#aiFab{position:fixed;right:16px;bottom:52px;width:26px;height:26px;border-radius:50%;
...
@media (max-width:480px){#aiPanel{right:8px;bottom:86px;width:calc(100vw - 16px);}}
</style>
<script>
(function(){
